...
dialog-add-caldav-preset-icloud = iCloud
dialog-add-caldav-icloud-note = Use your Apple ID email as the username, and an app-specific password (not your regular Apple ID password) — generate one at appleid.apple.com.
